...
mixin _$LoginParams {
 ...
 String get email; String get password; String get ipAddress; String get userAgent;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,email,password,ipAddress,userAgent);

@override
String toString() {
  return 'LoginParams(email: $email, password: $password, ipAddress: $ipAddress, userAgent: $userAgent)';
}
...
/// Create a copy of LoginParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,Object? ipAddress = null,Object? userAgent = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  String ipAddress,  String userAgent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginParams() when $default != null:
return $default(_that.email,_that.password,_that.ipAddress,_that.userAgent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  String ipAddress,  String userAgent)  $default,) {final _that = this;
switch (_that) {
case _LoginParams():
return $default(_that.email,_that.password,_that.ipAddress,_that.userAgent);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  String ipAddress,  String userAgent)?  $default,) {final _that = this;
switch (_that) {
case _LoginParams() when $default != null:
return $default(_that.email,_that.password,_that.ipAddress,_that.userAgent);case _:
  return null;
...
class _LoginParams implements LoginParams {
  const _LoginParams({required this.email, required this.password, required this.ipAddress, required this.userAgent});
...
/// Create a copy of LoginParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? email = null,Object? password = null,Object? ipAddress = null,Object? userAgent = null,}) {
