...
$GetUserParamsCopyWith<GetUserParams> get copyWith => _$GetUserParamsCopyWithImpl<GetUserParams>(this as GetUserParams, _$identity);
  ...
  /// Serializes this GetUserParams to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetUserParams&&(identical(other.userId, userId) || other.userId == userId));
}
...
/// Adds pattern-matching-related methods to [GetUserParams].
extension GetUserParamsPatterns on GetUserParams {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _GetUserParams value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _GetUserParams() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _GetUserParams value)  $default,){
final _that = this;
switch (_that) {
case _GetUserParams():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _GetUserParams value)?  $default,){
final _that = this;
switch (_that) {
case _GetUserParams() when $default != null:
return $default(_that);case _:
...
class _GetUserParams implements GetUserParams {
  const _GetUserParams({required this.userId});
  factory _GetUserParams.fromJson(Map<String, dynamic> json) => _$GetUserParamsFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$GetUserParamsToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GetUserParams&&(identical(other.userId, userId) || other.userId == userId));
}
