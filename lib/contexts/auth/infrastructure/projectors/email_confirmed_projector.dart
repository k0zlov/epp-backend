...
class EmailConfirmedProjector extends ProjectionHandler<EmailConfirmedEvent> {
  const EmailConfirmedProjector({required this.db});

  final Database db;

  @override
  Future<void> project(EmailConfirmedEvent event) async {
