...
class EmailConfirmationFailedProjector extends ProjectionHandler<EmailConfirmationFailedEvent> {
  const EmailConfirmationFailedProjector({required this.db});

  final Database db;

  @override
  Future<void> project(EmailConfirmationFailedEvent event) async {
